...
const FollowingMore = ({ showMore, setShowMore }) => {
    ...
    const FollowingRemainingData = [
        { id: 1, name: "Johnson", username: "@John", img: Fimg1 },
        { id: 2, name: "Pink", username: "@Pinkee", img: Fimg2 },
        { id: 3, name: "Brock", username: "@BrandonBran", img: Fimg3 },
        { id: 4, name: "Chutki", username: "@Chutki", img: Fimg4 },
        { id: 5, name: "Jassica", username: "@JassicaMia", img: Fimg5 }
    ];
            ...
            {FollowingRemainingData.map((val) => (
                <div key={val.id} style={{ marginTop: "20px" }} className="following-people">
                    <div className="following-details">
                        <img src={val.img} alt={`${val.name} profile`} />
                    ...
                    <button className='Rbtn' style={{ background: "linear-gradient(107deg, #6EACDA)" }}>Follow</button>
                </div>
            ))}
        </Modal>
    );
